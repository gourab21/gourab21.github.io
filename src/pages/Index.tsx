          ...
          <div className="container mx-auto max-w-4xl">
            <div className="flex flex-col md:flex-row items-center justify-between gap-8">
              ...
              <div className="flex flex-col items-center md:items-start text-center md:text-left space-y-6 md:w-2/3">
                ...
                <b>UGC NET JRF and Assistant Professor Qualified</b> Post  Graduate Student with expertise in <b>Machine Learning, IoT, UAV Security and AI</b>. Passionate about solving real-world problems through research and technology. <b>2x Winner Coding Contests</b> at prestigious institutions. Focused on <b>AI-driven security solutions</b> and machine Learning for a better Society.
                </p>
